...
* 把每一个模块、子模块、类、方法，都当做API来精心雕琢设计，为使用者提供便利。
...
* 新增的工具方法和关键业务逻辑必须编写配套的自动化测试用例（Java使用JUnit，C++使用Google Test）。
...
* 不依赖文档
    ...
    - 不要想当然地以文档、方法的命名或者自己的预期来判断代码的实际功能、内部逻辑与副作用。
